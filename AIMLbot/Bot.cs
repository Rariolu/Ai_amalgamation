        ...
        public string PathToConfigFiles
        {
            get
            {
                return Path.Combine(
                    ...
                    Environment.CurrentDirectory,
#endif
                    "..\\"+GlobalSettings.grabSetting("configdirectory"));
            }
        }
...
#region Settings methods
        ...
        public void loadSettings(string pathToSettings)
        {
            ...
            string directory = Path.GetDirectoryName(Path.GetFullPath(pathToSettings));
            ...
            ////this.Person2Substitutions.loadSettings(Path.GetFullPath(directory+"\\"+GlobalSettings.grabSetting("person2substitutionsfile")));
            //this.Person2Substitutions.loadSettings(Path.Combine(directory, this.GlobalSettings.grabSetting("person2substitutionsfile")));
            //PersonSubstitutions.loadSettings(Path.Combine(directory, GlobalSettings.grabSetting("personsubstitutionsfile")));
            ...
            //GenderSubstitutions.loadSettings(Path.Combine(directory, GlobalSettings.grabSetting("gendersubstitutionsfile")));
            ...
            //DefaultPredicates.loadSettings(Path.Combine(directory,GlobalSettings.grabSetting("defaultpredicates")));
            ...
            //Substitutions.loadSettings(Path.Combine(directory, GlobalSettings.grabSetting("substitutionsfile")));
            ...
            //loadSplitters(Path.Combine(directory, GlobalSettings.grabSetting("splittersfile")));
